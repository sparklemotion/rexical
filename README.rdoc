...
The sample directory contains description examples.
...
Send descriptions of phenomena that appear to be bugs to the address below.
If possible, attach the grammar file that will reproduce the bug.
